...
class Component {
    ...
    constructor({width = null, height = null, color = "blue", x = null, y = null, isPlayer = false} = {}, beforeFct){
        if(!width || !height || !x || !y) throw new Error("No width, or height, or x position, or y position");
        this._width = width;
        this._height = height;
        this._color = color;
        this._x = x;
